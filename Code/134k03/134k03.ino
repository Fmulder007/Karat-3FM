  ...
  if (knobdown && !knobup) { //Если кноб нажат
    ...
    if (knobupmillis - knobMillis < 1000 && knobupmillis - knobMillis > 100) { //Если кноб отпущен и был нажат и времени от таймера прошло 100Мс
      if (menu < 5 && menu > 0 && actfmenuf) { //Если 0<меню<5 и крутили енкодер в быстром меню, то выйти на главный экран
        ...
        if (menu > 15) menu = 5; //Если меню больше 15 перейти на меню 5
      }
...
void readencoder() { // работа с енкодером
  ...
  if (newPosition != oldPosition) { // ЕСЛИ КРУТИЛИ энкодер
    ...
    switch (menu) {
      ...
      case 7: //Настройка BFO гетеродина LSB
      ...
      case 8: //Настройка BFO гетеродина USB
      ...
      case 9: //Настройка опорного гетеродина 500кГц
      ...
      case 10: //Настройка калибровки кварца PLL
      ...
      case 11: //Настройка калибровки по питанию
      ...
      case 12: // Настройка количества диапазонов
...
void mainscreen() { //Процедура рисования главного экрана
  ...
  switch (menu) {
    ...
    case 5: //Меню 5 - Настройка min_freq
    ...
    case 6: //Меню 6 - Настройка maxfreq
    ...
    case 7: //Меню 7 - Настройка BFO гетеродина LSB
    ...
    case 8: //Меню 8 - Настройка BFO гетеродина USB
      display.setTextSize(2);
    ...
    case 9: //Меню 9 - Настройка опорного гетеродина 500кГц
    ...
    case 10: //Меню 10 - Настройка калибровки кварца
    ...
    case 11: //Меню 11 - Настройка калибровки по питанию
    ...
    case 12: //Меню 12 - Количество диапазонов
    ...
    case 13: //Меню 13 - Настройка Часов
    ...
    case 14: //Меню 14 - Настройка Минут
      if (tm.Minute < 10) display.print("0");
    ...
    case 15: //Меню 15 - Reverse Encoder
      if (reverse_encoder) {
        display.println("Yes");
      }
      else
