...
struct general_set {
  ...
  uint32_t bfo_freq = 34440000UL; // Начальная частота BFO при первом включении.
  uint32_t usb_lo_freq = 13560000UL; // Начальная частота опоры USB при первом включении.
  uint32_t lsb_lo_freq = 13557600UL; // Начальная частота опоры LSB при первом включении.
  int16_t Si_Xtall_calFreq = 5850; // Начальная частота калибровки кварца, Гц.
